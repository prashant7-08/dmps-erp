...
import { SERVICES_LIST } from '../components/layout/Navbar';
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-100 text-slate-700 text-xs font-bold uppercase tracking-wider border-b border-slate-200">
                    <th className="py-3.5 px-6">Student Strength</th>
                    <th className="py-3.5 px-6">Recommended Plan</th>
                    <th className="py-3.5 px-6">Cloud SaaS (Per Year)</th>
                    <th className="py-3.5 px-6">Offline ERP (Per Year)</th>
                ...
                <tbody className="divide-y divide-slate-200 text-sm">
                  {STUDENT_STRENGTH_MATRIX.slice(0, 4).map((tier, idx) => (
                    <tr key={idx} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-3.5 px-6 font-black text-indigo-600">
                        {tier.cloudSaaSPrice}
                      </td>
                      ...
                      <td className="py-3.5 px-6 text-end">
                        <button
                          ...
                          className="px-3 py-1 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs transition-colors shadow-sm"
                        >
                          Book Now
                        </button>
                      </td>
