...
export const CampusCctvPage = ({ onNavigate, onOpenContactModal }) => {
  const handleWhatsAppBooking = (msg = '') => {
    const text = encodeURIComponent(msg || "Hello PKR ENTERPRISES! I would like to get a quotation for Campus CCTV Surveillance, Mesh Wi-Fi & Annual AMC maintenance.");
