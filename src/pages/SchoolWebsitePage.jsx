...
export const SchoolWebsitePage = ({ onGoToLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-sky-600 selection:text-white flex flex-col justify-between">
      ...
      {/* 🏛️ 1. Main Brand Header & Navigation (On Top) */}
      <header className="sticky top-0 z-50 bg-white/95 text-slate-900 border-b border-slate-200 shadow-md backdrop-blur-md">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-t border-slate-200 px-4 py-6 space-y-2 shadow-2xl text-slate-800">
            ...
            <button onClick={() => navigateTo('about')} className="w-full text-left py-2 px-3 rounded-lg hover:bg-slate-50 font-bold text-sm">About & Society</button>
            <button onClick={() => navigateTo('founder')} className="w-full text-left py-2 px-3 rounded-lg hover:bg-slate-50 font-bold text-sm text-amber-700">👑 Founder's Vision</button>
            <button onClick={() => navigateTo('md')} className="w-full text-left py-2 px-3 rounded-lg hover:bg-slate-50 font-bold text-sm text-sky-700">💼 Manager's Message</button>
            <button onClick={() => navigateTo('principal')} className="w-full text-left py-2 px-3 rounded-lg hover:bg-slate-50 font-bold text-sm text-indigo-700">🎓 Principal's Desk</button>
            ...
            <button onClick={() => navigateTo('academic')} className="w-full text-left py-2 px-3 rounded-lg hover:bg-slate-50 font-bold text-sm">Academic Curriculum</button>
            <button onClick={() => navigateTo('selections')} className="w-full text-left py-2 px-3 rounded-lg hover:bg-slate-50 font-bold text-sm text-amber-600">🏆 Selections Hall of Fame</button>
            <button onClick={() => navigateTo('facilities')} className="w-full text-left py-2 px-3 rounded-lg hover:bg-slate-50 font-bold text-sm">Infrastructure</button>
            ...
            <button onClick={() => navigateTo('admissions')} className="w-full text-left py-2 px-3 rounded-lg bg-sky-50 text-sky-700 font-bold text-sm">Admissions 2026-27</button>
      ...
      {/* 🌟 2. News Ticker & Social Ribbon (Placed Below White Header) */}
      <div className="bg-[#0b1e38] text-slate-200 py-1.5 px-3 sm:px-6 text-xs border-b border-slate-800 shadow-sm relative z-40 overflow-hidden">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
          ...
          <div className="flex-1 overflow-hidden relative">
            <div className="animate-header-ticker text-[11px] sm:text-xs font-semibold select-none flex items-center">
              <div className="flex items-center gap-3 sm:gap-3.5 mr-[60vw] shrink-0">
          ...
          {/* 🔗 Right Side: Social Icons & School ERP Login */}
          <div className="flex items-center gap-2.5 shrink-0 ml-auto">
            <div className="hidden sm:flex items-center gap-1.5 border-r border-slate-700 pr-2.5 mr-0.5">
              <a href="https://www.instagram.com/dadheechschool/" target="_blank" rel="noopener noreferrer" title="Instagram @dadheechschool" className="p-1 rounded-md bg-slate-800 hover:bg-slate-700 hover:scale-110 transition-all shadow-sm">
                <InstagramIcon className="w-3.5 h-3.5" />
              </a>
              <a href="https://www.facebook.com/dadheech.dadheech.37/" target="_blank" rel="noopener noreferrer" title="Facebook (Schools)" className="p-1 rounded-md bg-slate-800 hover:bg-slate-700 hover:scale-110 transition-all shadow-sm">
                <FacebookIcon className="w-3.5 h-3.5" />
              </a>
              <a href="https://www.youtube.com/@dadheechactivities1379" target="_blank" rel="noopener noreferrer" title="YouTube Channel" className="p-1 rounded-md bg-slate-800 hover:bg-slate-700 hover:scale-110 transition-all shadow-sm">
                <YouTubeIcon className="w-3.5 h-3.5" />
              </a>
              <a href="https://play.google.com/store/apps/details?id=co.thanos.iymus&pcampaignid=web_share" target="_blank" rel="noopener noreferrer" title="Dadheech Classes App" className="p-1 rounded-md bg-slate-800 hover:bg-slate-700 hover:scale-110 transition-all shadow-sm">
            ...
            <button
              onClick={onGoToLogin}
              className="px-3 py-1 rounded-md bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-[#0b1e38] font-black text-[11px] flex items-center gap-1 shadow transition-all whitespace-nowrap"
            >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-xl border border-slate-200 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              ...
              >
                ...
                <div>
                  <div className="text-xs sm:text-sm font-black uppercase tracking-wider">Academic Curriculum</div>
                  <div className="text-[10px] sm:text-xs text-slate-500 font-medium">BSB Board • PG to 12th</div>
                </div>
              </button>
            </div>
          </div>
      ...
      <footer className="bg-[#0b1e38] text-slate-300 pt-12 pb-6 text-xs border-t border-slate-800 mt-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 border-t border-slate-800 flex flex-wrap items-center justify-between gap-4 text-xs text-slate-400">
          <p>© Dadheech Memorial Public School (DMPS). All Rights Reserved.</p>
