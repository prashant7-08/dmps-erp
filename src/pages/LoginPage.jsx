...
import { Shield, Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, CheckCircle2, ChevronDown, ChevronUp, GraduationCap, Users, UserCheck, CreditCard, Award } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-300">
        ...
        {/* Top Purple/Blue Brand Header */}
        <div className="bg-gradient-to-b from-blue-900 via-indigo-900 to-indigo-950 text-white pt-8 pb-7 px-6 text-center rounded-b-3xl shadow-md relative">
          <div className="w-14 h-14 bg-white/15 backdrop-blur-md rounded-2xl flex items-center justify-center mx-auto mb-3 border border-white/30 shadow-inner">
            <GraduationCap className="w-8 h-8 text-amber-300" />
          </div>
          <h1 className="text-xl font-black tracking-tight text-white leading-snug">
            Dadheech Memorial Public School
          </h1>
          <p className="text-[11px] text-indigo-200 mt-1 font-semibold uppercase tracking-wider">
