...
export const SettingsPage = () => {
  ...
  const moduleList = [
    { key: 'dashboard', label: '1. Dashboard & Analytics', icon: '📊', actions: [{ key: 'view', label: 'View Dashboard' }, { key: 'export', label: 'Export Reports' }] },
    { key: 'reception', label: '2. Reception / Front Desk', icon: '🏢', actions: [{ key: 'view', label: 'View Inquiries' }, { key: 'inquiries', label: 'Manage Inquiries' }, { key: 'passes', label: 'Issue Gate Passes' }, { key: 'grievance', label: 'Manage Grievances' }] },
    { key: 'admission', label: '3. Admission Module', icon: '📝', actions: [{ key: 'view', label: 'View Admissions' }, { key: 'create', label: 'New Admission' }, { key: 'edit', label: 'Edit Form' }, { key: 'delete', label: 'Cancel/Delete' }] },
    { key: 'students', label: '4. Student Details & Directory', icon: '🎓', actions: [{ key: 'view', label: 'View Profiles' }, { key: 'edit', label: 'Update Details' }, { key: 'delete', label: 'Delete Student' }, { key: 'import', label: 'Import Excel / CSV' }, { key: 'idCards', label: 'Print ID Cards' }] },
    { key: 'staff', label: '5. Human Resource (Staff & HR)', icon: '👥', actions: [{ key: 'view', label: 'View Staff' }, { key: 'create', label: 'Add Employee' }, { key: 'edit', label: 'Edit Staff' }, { key: 'delete', label: 'Remove Staff' }, { key: 'payroll', label: 'Manage Payroll' }, { key: 'leave', label: 'Approve Leaves' }, { key: 'awards', label: 'Manage Awards' }] },
    { key: 'student_accounting', label: '6. Student Accounting (Fees)', icon: '💳', actions: [{ key: 'view', label: 'View Invoices' }, { key: 'collect', label: 'Collect Fee (POS)' }, { key: 'dues', label: 'Due List & Reminders' }, { key: 'discount', label: 'Apply Concession' }, { key: 'refund', label: 'Fee Refund' }, { key: 'structure', label: 'Fee Structure' }] },
    { key: 'office_accounting', label: '7. Office Accounting (Cashbook)', icon: '💰', actions: [{ key: 'view', label: 'View Daybook' }, { key: 'deposit', label: 'New Deposit' }, { key: 'expense', label: 'New Expense' }, { key: 'transactions', label: 'Transactions' }, { key: 'vouchers', label: 'Vouchers' }] },
    { key: 'supervision', label: '8. Supervision (Transport & Hostel)', icon: '🚌', actions: [{ key: 'view', label: 'View Routes' }, { key: 'routes', label: 'Route Master' }, { key: 'vehicles', label: 'Vehicle Fleet' }, { key: 'stoppage', label: 'Stoppage Master' }, { key: 'assign', label: 'Assign Bus Stop' }, { key: 'hostel', label: 'Hostel' }, { key: 'medical', label: 'Medical' }] },
    { key: 'attendance', label: '9. Attendance & Biometrics', icon: '⏱️', actions: [{ key: 'view', label: 'View Registers' }, { key: 'markStudents', label: 'Mark Students' }, { key: 'markStaff', label: 'Mark Staff' }, { key: 'biometricSync', label: 'Biometric Wi-Fi Sync' }, { key: 'monthlyRegister', label: 'Monthly Register' }] },
    { key: 'inventory', label: '10. Inventory & Stock', icon: '📦', actions: [{ key: 'view', label: 'View Stock' }, { key: 'addItem', label: 'Add Item' }, { key: 'issueItem', label: 'Issue Items' }, { key: 'stockAlerts', label: 'Stock Alerts' }] },
    { key: 'card_management', label: '11. Card Management', icon: '🪪', actions: [{ key: 'view', label: 'View Cards' }, { key: 'studentId', label: 'Student ID Cards' }, { key: 'employeeId', label: 'Employee ID Cards' }, { key: 'admitCards', label: 'Admit Cards' }] },
    { key: 'certificate', label: '12. Certificates & TC', icon: '📜', actions: [{ key: 'view', label: 'View Certificates' }, { key: 'generateTC', label: 'Generate TC' }, { key: 'characterCert', label: 'Character Cert' }, { key: 'sportsCert', label: 'Sports Cert' }] },
    { key: 'academic', label: '13. Academic & Timetable', icon: '📚', actions: [{ key: 'view', label: 'View Academics' }, { key: 'classes', label: 'Control Classes' }, { key: 'subjects', label: 'Subjects' }, { key: 'assignTeacher', label: 'Assign Class Teacher' }, { key: 'timetable', label: 'Timetable Schedules' }, { key: 'promotion', label: 'Student Promotion' }] },
    { key: 'homework', label: '14. Homework & Evaluation', icon: '📖', actions: [{ key: 'view', label: 'View Homework' }, { key: 'assignHomework', label: 'Daily Homework' }, { key: 'evaluate', label: 'Evaluation Report' }] },
    { key: 'exam_master', label: '15. Exam Master & Marks', icon: '🏆', actions: [{ key: 'view', label: 'View Exams' }, { key: 'examSetup', label: 'Exam Setup' }, { key: 'schedule', label: 'Exam Schedule' }, { key: 'enterMarks', label: 'Enter Marks' }, { key: 'reportCards', label: 'Print Report Cards' }] },
    { key: 'library', label: '16. Library & Books', icon: '📚', actions: [{ key: 'view', label: 'View Library' }, { key: 'catalog', label: 'Book Catalogs' }, { key: 'issueBook', label: 'Issue Books' }, { key: 'returnBook', label: 'Return Books' }] },
    { key: 'events_sports', label: '17. Events & Sports', icon: '🏅', actions: [{ key: 'view', label: 'View Events' }, { key: 'manageSports', label: 'Sports Tournaments' }, { key: 'academicCalendar', label: 'Holiday Calendar' }] },
    { key: 'sms_notices', label: '18. Bulk SMS & Notices', icon: '📢', actions: [{ key: 'view', label: 'View Notices' }, { key: 'publishNotice', label: 'Publish Circular' }, { key: 'sendSMS', label: 'Send Bulk SMS' }] },
    { key: 'reports', label: '19. Consolidated Reports', icon: '📈', actions: [{ key: 'view', label: 'View Reports' }, { key: 'exportReports', label: 'Export All Reports' }] },
    { key: 'settings', label: '20. Settings & System Backup', icon: '⚙️', actions: [{ key: 'view', label: 'View Settings' }, { key: 'backup', label: 'Create 1-Click Backup' }, { key: 'restore', label: 'Restore Database' }, { key: 'permissions', label: 'Modify Permissions' }, { key: 'schoolProfile', label: 'School Profile' }] }
  ];
